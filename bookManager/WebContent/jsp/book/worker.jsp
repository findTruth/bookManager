	...
	$.getJSON(url, function(data) {
		...
		if(pageTotal == 1) { // 当只有一页时  
			for(var j = 0; j < totalCount; j++) {
				$(".li-tag").eq(j).append("<span><img src='<%=basePath %>"+dataRoot[j].ADDRESS+"' /></span>&nbsp;&nbsp;&nbsp;&nbsp;<h2><a href='#'>"+dataRoot[j].NAME+"</a></h2><p><a href='#'>收藏</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#'>订阅</a></p>");
			}
		} else {
			...
			for(var j = startPage, k = 0; j < endPage, k < pageSize; j++, k++) {
				...
				$(".li-tag").eq(k).append("<span><img src='<%=basePath %>"+dataRoot[j].ADDRESS+"' /></span>&nbsp;&nbsp;&nbsp;&nbsp;<h2><a href='#'>"+dataRoot[j].NAME+"</a></h2><p><a href='#'>收藏</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#'>订阅</a></p>");
			}
		}
